            ...
            <div class="billing-address">
                ...
                <div class="card-content">
                    <ul>
                        ...
                        <li class="mb-10">
                            {{ $billingAddress->area }},{{ $billingAddress->block }}
                        </li>
                        <li class="mb-10">
                            {{ $billingAddress->address1 }},{{ $billingAddress->avnue }}
                        </li>
                        <li class="mb-10">
                            {{ $billingAddress->building }},<br/>
                        </li>
            ...
            <div class="shipping-address">
                ...
                <div class="card-content">
                    <ul>
                        ...
                        <li class="mb-10">
                            {{ $shippingAddress->area }},{{ $shippingAddress->block }}
                        </li>
                        <li class="mb-10">
                            {{ $shippingAddress->address1 }},{{ $shippingAddress->avnue }}
                        </li>
                        <li class="mb-10">
                            {{ $shippingAddress->building }},<br/>
                        </li>
