    ...
    <script>
        ...
        Vue.component('checkout', {
            ...
            methods: {
                ...
                addArea: function (type, name) {
                    this_this = this;

                    if (type == 'billing') {
                        this_this.address.billing.area = name;
                    } else if (type == 'shipping') {
                        this_this.address.shipping.area = name;
                    }
                ...
                removeArea: function (type) {
                    ...
                    if (type == 'billing') {
                        this_this.address.billing.area = '';
                    } else if (type == 'shipping') {
                        this_this.address.shipping.area = '';
                    }
                },
