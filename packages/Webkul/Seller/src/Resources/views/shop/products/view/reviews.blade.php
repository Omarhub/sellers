...
@if ($total = $reviewHelper->getTotalReviews($product))
    <div class="rating-reviews rating-reviews-custom">
...
@else
    ...
    @else
        <div class="rating-reviews">
            <div class="rating-header">
                <div class="no-seller" style="padding-left: 25px; color: red;">
                    {{ __('seller::app.shop.products.no-review') }}
                </div>
            </div>
        </div>
    @endif
