...
<div class="product-image-group">
    ...
    @include ('seller::shop.products.view.product-add')
    ...
    <script type="text/x-template" id="product-gallery-template">
        <div>
            ...
            <ul class="thumb-list">
                ...
                <li class="thumb-frame" v-for='(thumb, index) in thumbs' @mouseover="changeImage(thumb)" :class="[thumb.large_image_url == currentLargeImageUrl ? 'active' : '']" id="thumb-frame" style = "width: 110px;max-height: 110px;">
            ...
            <div class="product-hero-image" id="product-hero-image" >
                <img :src="currentLargeImageUrl" id="pro-img" :data-image="currentOriginalImageUrl" style = "height: 473px; width: 478px;"/>
