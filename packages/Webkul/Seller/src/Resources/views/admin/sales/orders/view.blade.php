                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th>{{ __('seller::app.sales.orders.seller-name') }}</th>
                                                <th>{{ __('seller::app.sales.orders.item-condition') }}</th>
                                                <th>{{ __('seller::app.sales.orders.warranty') }}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php  $sellerId = $item['additional']['seller_info']['seller_id'];
                                                $sellerProductId = $item['additional']['seller_info']['product_id'];
                                                $productRepository = app('Webkul\Seller\Repositories\ProductRepository');
                                                $seller = $productRepository->getSellerName($sellerId);
                                                $sellerProduct = $productRepository->sellerProduct($sellerProductId);
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="qty-row" style="color:blue">
