...
@section('content-wrapper')
    <div class="content full-page">
        <form method="POST" action="{{ route('seller.admin.sales.shipments.store', $order->id) }}" @submit.prevent="onSubmit">
            @csrf()
                                            ...
                                            @foreach ($order->channel->inventory_sources as $key => $inventorySource)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                            ...
                                                            foreach ($product->inventories as $inventory) {
                                                                if ($inventory->inventory_source_id == $inventorySource->id && $sellerProductId == $inventory->vendor_id) {
                                                    ...
                                                    <td>
                                                        ...
                                                        <input type ="hidden" name ="vendor_id" value ="{{$sellerProductId}}">
